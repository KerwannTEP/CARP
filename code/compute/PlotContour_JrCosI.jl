...
p = Plots.contourf(tabCosI,tabJr,tabdFdt,color=:bluesreds, clims= (-pref, pref).* maxdata, xlabel="cos I", ylabel=L"J_{\mathrm{r}}", title=L" \partial F/\partial t \ [ \ \!\!\!\!\! \times\!\! 10^5]")
